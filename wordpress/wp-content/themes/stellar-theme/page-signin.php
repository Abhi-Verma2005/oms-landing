        ...
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
            <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                ...
                <div class="max-w-sm mx-auto">
                    ...
                    <form method="post" action="<?php echo esc_url(home_url('/signin')); ?>">
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm text-slate-300 font-medium mb-1" for="user_login">Email</label>
                                <input id="user_login" name="log" class="form-input w-full" type="email" required />
                            </div>
                            <div>
                                <div class="flex justify-between">
                                    <label class="block text-sm text-slate-300 font-medium mb-1" for="user_pass">Password</label>
                                    <a class="text-sm font-medium text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out ml-2" href="<?php echo esc_url(wp_lostpassword_url()); ?>">Forgot?</a>
                                </div>
                                <input id="user_pass" name="pwd" class="form-input w-full" type="password" autocomplete="on" required />
                            </div>
                        </div>
                        <div class="mt-6">
                    ...
                    <div class="text-center mt-4">
                        <div class="text-sm text-slate-400">
                            Don't have an account? <a class="font-medium text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out" href="<?php echo esc_url(home_url('/signup')); ?>">Sign up</a>
                        </div>
                    </div>
