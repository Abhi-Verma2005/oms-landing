 ...
 * under Settings → Reading. It mirrors the Blog Page template.
 *
        ...
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
            <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                ...
                <div class="max-w-3xl mx-auto text-center pb-12">
                    <h1 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60"><?php esc_html_e('Blog', 'stellar'); ?></h1>
                    <p class="text-slate-400 mt-4"><?php esc_html_e("Read our latest articles, updates and insights.", 'stellar'); ?></p>
                </div>
                            ...
                            <article class="relative group">
                                ...
                                <div class="relative px-7 py-6 bg-slate-800 rounded-lg border border-slate-700">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a class="text-purple-500 hover:text-purple-400 transition-colors" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more', 'stellar'); ?> →</a>
                                    </div>
                                </div>
                            </article>
                        <?php endwhile; ?>
