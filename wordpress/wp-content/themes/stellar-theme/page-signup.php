                    ...
                    <form method="post" action="<?php echo esc_url(wp_registration_url()); ?>">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input id="company" name="company" class="form-input w-full" type="text" placeholder="E.g., Acme Inc." required />
                            </div>
                            <div>
                                <label class="block text-sm text-slate-300 font-medium mb-1" for="full-name">Full Name <span class="text-rose-500">*</span></label>
                                <input id="full-name" name="first_name" class="form-input w-full" type="text" placeholder="E.g., Mark Rossi" required />
                            </div>
                            <div>
                                <label class="block text-sm text-slate-300 font-medium mb-1" for="user_email">Email <span class="text-rose-500">*</span></label>
                                <input id="user_email" name="user_email" class="form-input w-full" type="email" placeholder="markrossi@company.com" required />
                            </div>
                            <div>
                                <label class="block text-sm text-slate-300 font-medium mb-1" for="user_pass">Password <span class="text-rose-500">*</span></label>
                                <input id="user_pass" name="user_pass" class="form-input w-full" type="password" autocomplete="on" required />
                            </div>
                            <div>
                                ...
                                <select id="referrer" name="referrer" class="form-select text-sm py-2 w-full" required>
                        ...
                        <?php wp_nonce_field('wp_register_form'); ?>
                    </form>
